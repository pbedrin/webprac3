...
* Статусы заказа: "В работе", "Отменён", "Завершён", "На тест-драйве".
...
* Меню, содержащее ссылки на основные страницы сайта: каталог автомобилей, список моделей, список производителей, список клиентов, список заказов.
...
* В списке в карточке каждого автомобиля приведена краткая информация о нём (производитель, модель, год выпуска, пробег, цена). По клику на модель можно перейти на страницу модели. По клику на производителя можно перейти на страницу производителя. Кнопка "Удалить", удаляющая автомобиль из БД. Кнопка "Редактировать", переводящая на страницу редактирования автомобиля. Кнопка "Посмотреть", переводяшая на страницу автомобиля.
...
* Кнопка "Удалить", удаляющая автомобиль из БД.

#### **Редактирование автомобиля**
Форма редактирования автомобиля с различными полями. Аналогично добавлению.
...
* В списке в карточке каждой модели приведена краткая информация о ней (производитель, название модели). По клику на производителя можно перейти на страницу производителя. Кнопка "Удалить", удаляющая модель из БД (каскадно удаляются автомобили модели). Кнопка "Редактировать", переводящая на страницу редактирования модели. Кнопка "Посмотреть", переводяшая на страницу модели.
...
* Кнопка "Удалить", удаляющая модель из БД (каскадное удаление всех автомобилей модели).
...
* Кнопка "Удалить" (каскадное удаление всех моделей и автомобилей этого производителя). Поле редактирования имени производителя. Кнопка "Посмотреть", переводяшая на страницу производителя.
...
* Кнопка "Удалить", удаляющая производителя из БД (каскадное удаление всех автомобилей производителя).
...
* В списке в карточке каждого клиента приведена краткая информация о нём (ФИО, телефон, email). Кнопка "Удалить", удаляющая клиента из БД (каскадно все его заказы и тест-драйвы). Кнопка "Редактировать", переводящая на страницу редактирования клиента. Кнопка "Посмотреть", переводяшая на страницу клиента.
...
* Кнопка "Удалить", удаляющая клиента из БД (каскадно все его заказы и тест-драйвы).
...
* В списке в карточке каждого заказа приведена краткая информация о нём (ФИО клиента - кликабельно, производитель + модель автомобиля - кликабельно). Кнопка "Удалить", удаляющая заказ из БД. Кнопка "Редактировать", переводящая на страницу редактирования заказа. Кнопка "Посмотреть", переводяшая на страницу заказа.
...
* Чекбокс "Нужен тест-драйв".
* Статус заказа. Выпадающий список статусов.
* Дата и время заполняются автоматически при создании.
...
* Кнопка "Удалить", удаляющая заказ из БД.
...
#### **Удалить автомобиль**
Аналогично "Редактировать заказ", но кнопка "Удалить"